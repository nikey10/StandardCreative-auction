...
const CreateBid = () => {
  ...
  const createBid = async () => {
    ...
    try {
      const tx = await contract.createBid(parseInt(auctionId), bidType == '0' ? false : true, {
  ...
  return (
    <div className="create-nft-contract">
      Create Bid
      <input type="text" placeholder="Auction Id" value={auctionId} onChange={(e) => setAuctionId(e.target.value)} />
      <input
        type="text"
