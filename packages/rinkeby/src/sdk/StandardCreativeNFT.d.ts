...
interface StandardCreativeNFTInterface extends ethers.utils.Interface {
  functions: {
...
export class StandardCreativeNFT extends BaseContract {
  ...
  interface: StandardCreativeNFTInterface
