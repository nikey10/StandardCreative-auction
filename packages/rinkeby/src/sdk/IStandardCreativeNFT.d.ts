...
interface IStandardCreativeNFTInterface extends ethers.utils.Interface {
  functions: {
...
export class IStandardCreativeNFT extends BaseContract {
  ...
  interface: IStandardCreativeNFTInterface
