...
const SingleBid = (props) => {
	...
	const SwitchBid = async () => {
		await switchTopBidToOpenEdition(id)
	}
	return (
		<>
		...
		<BaseModal label="Notification" show={isAmount} closeModal={closeModal}>
			<h1 className="modal-title" >This is less than topBidAmount!</h1>
		</BaseModal>
		</>
	)
}
