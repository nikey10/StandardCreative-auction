...
const CreateAuction = () => {
  ...
  const createAuction = async () => {
    ...
    if (result) {
    //   const newId = ethers.utils.defaultAbiCoder.decode(['uint256'], result.logs[0].topics[1])[0].toString()
    //   const newnftContract = ethers.utils.defaultAbiCoder
    //     .decode(['uint256'], result.logs[0].topics[2])[0]
    //     .toHexString(16)
    //   console.log('newId', newId, newnftContract, minimumBidIncrementFor1of1)

    //   await axios
    //     .post(server_url + '/create-auction', {
    //       auctionId: newId,
    //       nftAddress: newnftContract,
    //       creatorAddress: address,
    //       creatorShare: creatorSharePercent,
    //       openEditionPrice: fixedPriceForOpenEdition,
    //       minBidIncrement: minimumBidIncrementFor1of1,
    //       duration: auctionLength,
    //       durationIncrement: auctionIncrementLength
    //     })
    //     .then((res) => {
    //       console.log(res)
